...
/**
 * Elementor synck synckpagesaboutservicelight Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_synck_synckpagesaboutservicestyle2_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'synckpagesaboutservicelight';
    }
    ...
    public function get_title() {
        return esc_html__( 'Pages About Service Style2', 'synck-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .about-service4-area'=> 'background-color: {{VALUE}} !important;',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .about-service4-inner'=> 'background-color: {{VALUE}} !important;',
                ],
    ...
    protected function render() {
        ...
        $synckpagesaboutservicelight_output = $this->get_settings_for_display(); ?>
...
<div class="about-service4-inner d-flex align-items-center">
    <div class="img-box">
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicelight_output['abt_serv_img']['id'], 'full' ));?>"  />
    </div>

    <div class="content-box">
        <h2><?php echo ($synckpagesaboutservicelight_output['heading']); ?></h2>

        <?php echo ($synckpagesaboutservicelight_output['content']); ?>
        <ul>
            <?php if(!empty($synckpagesaboutservicelight_output['list1'])):
            foreach ($synckpagesaboutservicelight_output['list1'] as $synckpagesaboutservicelight_loop):?>
            <li>
            <i class="<?php echo esc_attr($synckpagesaboutservicelight_loop['check_icon']);?>"></i> <?php echo esc_html($synckpagesaboutservicelight_loop['check_list']); ?>
            </li>
