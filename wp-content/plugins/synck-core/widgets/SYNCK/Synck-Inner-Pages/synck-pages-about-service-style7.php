...
/**
 * Elementor synck synckpagesaboutservicestyle7 Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_synck_synckpagesaboutservicestyle7_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'synckpagesaboutservicestyle7';
    }
    ...
    public function get_title() {
        return esc_html__( 'Pages About Service Style7', 'synck-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'synckpagesaboutservicestyle7_design_option',
            [
        ...
        $this->add_control(
            'synckpagesaboutservicestyle7_heading_color',
            [
                'label'         => esc_html__( 'Heading Text Color', 'synck-core' ),
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .about-service3-area h2'=> 'color: {{VALUE}} !important;',
                ],
        ...
        $this->add_group_control(
            ...
            [
                'name'          => 'synckpagesaboutservicestyle7_heading_typography',
                'label'         => esc_html__( 'Heading Typography', 'synck-core' ),
                'selector'      => 
                    '{{WRAPPER}} .about-service3-area h2',
            ]
        );

        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_heading_margin',
            [
                'label'         => __( 'Heading Margin', 'synck-core' ),
                'type'          => elementor\Controls_Manager::DIMENSIONS,
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .about-service3-area h2' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_heading_padding',
            [
                'label'         => __( 'Heading Padding', 'synck-core' ),
                'type'          => elementor\Controls_Manager::DIMENSIONS,
                'size_units'    => [ 'px', '%', 'em' ],
                'selectors'     => [
                    '{{WRAPPER}} .about-service3-area h2' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'synckpagesaboutservicestyle7_content_color',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name'          => 'synckpagesaboutservicestyle7_content_typography',
        ...
        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_content_margin',
            [
        ...
        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_content_padding',
            [
        ...
        $this->add_control(
            'synckpagesaboutservicestyle7_title_color',
            [
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
            [
                'name'          => 'synckpagesaboutservicestyle7_title_typography',
        ...
        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_title_margin',
            [
        ...
        $this->add_responsive_control(
            'synckpagesaboutservicestyle7_title_padding',
            [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .about-service5-area'=> 'background-color: {{VALUE}} !important;',
                ],
    ...
    protected function render() {
        ...
        $synckpagesaboutservicestyle7_output = $this->get_settings_for_display(); ?>
...
<div class="custom-container">
    <div class="custom-row align-items-center">
        <div class="img-box">
            <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicestyle7_output['abt_serv_img']['id'], 'full' ));?>" />
        </div>

        <div class="content-box">
            <h2><?php echo ($synckpagesaboutservicestyle7_output['heading']); ?></h2>

                <?php echo ($synckpagesaboutservicestyle7_output['content']); ?>
            <ul>
                <?php if(!empty($synckpagesaboutservicestyle7_output['list1'])):
                foreach ($synckpagesaboutservicestyle7_output['list1'] as $synckpagesaboutservicestyle7_loop):?>
                <li>
                <i class="<?php echo esc_attr($synckpagesaboutservicestyle7_loop['check_icon']);?>"></i> <?php echo esc_html($synckpagesaboutservicestyle7_loop['check_list']); ?>
                </li>
