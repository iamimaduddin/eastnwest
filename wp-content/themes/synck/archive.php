...
<section class="blog-breadcrumb-area">
    <div class="custom-container custom-container-blog">
        <ul class="breadcrumb-list">
            ...
            <li><?php esc_html_e( 'Archives', 'synck' )?></li>
        </ul>
        <h2><?php
                        if ( is_day() ) :
                            esc_html_e( ' DAILY ARCHIVES: ', 'synck' );

                        elseif ( is_month() ) :
                            esc_html_e( ' MONTHLY ARCHIVES: ', 'synck' );

                        
                        elseif ( is_year() ) :
                            esc_html_e( ' YEARLY ARCHIVES: ', 'synck' );
